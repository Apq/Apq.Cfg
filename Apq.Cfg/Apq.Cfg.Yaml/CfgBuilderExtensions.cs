...
public static class CfgBuilderExtensions
{
    ...
    /// <param name="level">配置层级，数值越大优先级越高，默认为 <see cref="CfgSourceLevels.Yaml"/> (0)</param>
    ...
    public static CfgBuilder AddYamlFile(this CfgBuilder builder, string path, int level = CfgSourceLevels.Yaml, bool writeable = false,
