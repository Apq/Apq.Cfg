...
| **HclCfgTests** | **6** | **0** | **HOCON 文件配置源测试** |
| **PropertiesCfgTests** | **7** | **0** | **Properties 文件配置源测试** |
...
| API | Json | EnvVar | .env | Ini | Xml | Yaml | Toml | Hcl | Properties | Redis | DB | Zk | Apollo | Consul | Etcd | Nacos | Vault |
|-----|:----:|:------:|:----:|:---:|:---:|:----:|:----:|:---:|:----------:|:-----:|:--:|:--:|:------:|:------:|:----:|:-----:|:-----:|
| **ICfgRoot** |
| `Get(key)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `Get<T>(key)` | ✅ | - | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | - | - | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| 场景类别 | 测试文件 | 测试数量 | 跳过 |
|----------|----------|----------|------|
| 基本读写 | JsonCfgTests, EnvCfgTests, 各格式测试 | 123 | 41 |
