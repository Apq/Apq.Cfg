...
## EncodingMappingConfig\.RemoveReadMapping\(string, Nullable\<EncodingMappingType\>\) Method

移除读取编码映射规则

```csharp
public Apq.Cfg.EncodingSupport.EncodingMappingConfig RemoveReadMapping(string pattern, System.Nullable<Apq.Cfg.EncodingSupport.EncodingMappingType> type=null);
```
#### Parameters

<a name='Apq.Cfg.EncodingSupport.EncodingMappingConfig.RemoveReadMapping(string,System.Nullable_Apq.Cfg.EncodingSupport.EncodingMappingType_).pattern'></a>

`pattern` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

匹配模式

<a name='Apq.Cfg.EncodingSupport.EncodingMappingConfig.RemoveReadMapping(string,System.Nullable_Apq.Cfg.EncodingSupport.EncodingMappingType_).type'></a>
