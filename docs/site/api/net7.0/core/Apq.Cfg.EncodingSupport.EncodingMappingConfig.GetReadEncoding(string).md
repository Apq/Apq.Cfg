...
## EncodingMappingConfig\.GetReadEncoding\(string\) Method

获取文件的读取编码

```csharp
public System.Text.Encoding? GetReadEncoding(string filePath);
```
#### Parameters

<a name='Apq.Cfg.EncodingSupport.EncodingMappingConfig.GetReadEncoding(string).filePath'></a>
