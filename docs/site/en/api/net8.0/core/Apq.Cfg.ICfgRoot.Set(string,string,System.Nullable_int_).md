...
## ICfgRoot\.Set\(string, string, Nullable\<int\>\) Method
...
<a name='Apq.Cfg.ICfgRoot.Set(string,string,System.Nullable_int_).key'></a>

`key` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

配置键

<a name='Apq.Cfg.ICfgRoot.Set(string,string,System.Nullable_int_).value'></a>

`value` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

配置值

<a name='Apq.Cfg.ICfgRoot.Set(string,string,System.Nullable_int_).targetLevel'></a>
