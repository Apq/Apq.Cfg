...
## ChaCha20CryptoProvider Class

ChaCha20\-Poly1305 加密提供者（使用 BouncyCastle 实现）

```csharp
public class ChaCha20CryptoProvider : Apq.Cfg.Crypto.ICryptoProvider, System.IDisposable
```

Inheritance [System\.Object](https://learn.microsoft.com/en-us/dotnet/api/system.object 'System\.Object') &#129106; ChaCha20CryptoProvider
