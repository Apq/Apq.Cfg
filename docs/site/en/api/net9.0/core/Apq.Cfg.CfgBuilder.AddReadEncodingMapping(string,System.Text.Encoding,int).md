...
## CfgBuilder\.AddReadEncodingMapping\(string, Encoding, int\) Method

添加读取编码映射（完整路径）

```csharp
public Apq.Cfg.CfgBuilder AddReadEncodingMapping(string filePath, System.Text.Encoding encoding, int priority=100);
```
#### Parameters

<a name='Apq.Cfg.CfgBuilder.AddReadEncodingMapping(string,System.Text.Encoding,int).filePath'></a>

`filePath` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

文件完整路径

<a name='Apq.Cfg.CfgBuilder.AddReadEncodingMapping(string,System.Text.Encoding,int).encoding'></a>

`encoding` [System\.Text\.Encoding](https://learn.microsoft.com/en-us/dotnet/api/system.text.encoding 'System\.Text\.Encoding')

编码

<a name='Apq.Cfg.CfgBuilder.AddReadEncodingMapping(string,System.Text.Encoding,int).priority'></a>
