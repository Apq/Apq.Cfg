...
Apollo 是携程开源的分布式配置中心，支持配置的集中管理、灰度发布、版本管理等功能。
...
启用 `EnableHotReload` 后，配置源会使用 Apollo 的长轮询通知机制监听配置变更：
...
- [Nacos](/config-sources/nacos) - Nacos 配置中心
